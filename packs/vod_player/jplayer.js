...
document.write('<link href="'+parent.ms_root+'packs/vod_player/jplayer/skin/blue/css.css" rel="stylesheet" type="text/css" />');
document.write('<script type="text/javascript" src="'+parent.ms_root+'packs/vod_player/jplayer/js/jquery.js"></script>');
document.write('<script type="text/javascript" src="'+parent.ms_root+'packs/vod_player/jplayer/js/jquery.jplayer.min.js"></script>');

function $Showhtml(){
    document.getElementById('playad').style.display = "none";
    var playhtml='<div class="oldPlayer"><div id="msvod_jplayer"class="jp-jplayer"></div><div id="jp_container_1"class="jp-audio"><div class="jp-type-single"><div class="jp-interface clearfix"><div class="playerMain-01"><p><span id="PlayStateTxt">正在播放:</span><span id="play_lookname">'+urlname+'</span></p><div class="jp-time-holder"><div class="jp-current-time">00:00</div>/<div class="jp-duration">00:00</div></div></div><div class="playerMain-02"><div class="jp-progress"><div class="jp-seek-bar"><div class="jp-play-bar"></div></div></div></div><div class="playerMain-03"><div class="fl"><ul class="jp-controls"><li><a href="'+surl+'"class="jp-previous"tabindex="1">上一部</a></li><li><a href="javascript:{};"class="jp-play"tabindex="1">播放</a></li><li><a style="display:none;"href="javascript:{};"class="jp-pause"tabindex="1">暂停</a></li><li><a href="'+xurl+'"class="jp-next"tabindex="1">下一部</a></li></ul></div>';
    ...
    $("#msvod_jplayer").jPlayer({
        supplied: "mp3,m4a",
        swfPath: parent.ms_root+"packs/vod_player/jplayer/js",
        wmode: "window",
...
function getjp_play() {
	if(jpurl.indexOf(".m4a")>0){
		$("#msvod_jplayer").jPlayer("setMedia", {m4a:jpurl}).jPlayer("play");
	}else{
		$("#msvod_jplayer").jPlayer("setMedia", {mp3:jpurl}).jPlayer("play");
	}
}
