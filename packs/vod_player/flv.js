...
var flashvars = {
	...
	sound_sample : "1",
	//插件设置
	plugins : parent.ms_root + "packs/vod_player/cmp/sharing.swf",
	//皮肤
	skin : parent.ms_root + "packs/vod_player/cmp/vplayer.swf",
	api : "cmp_loaded"
};

function $Showhtml(){
    document.getElementById('playad').style.display = "none";
    document.getElementById('playlist').innerHTML = CMP.create("cmp", "100%", height, parent.ms_root + "packs/vod_player/cmp/cmp.swf", flashvars);
}
