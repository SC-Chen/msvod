...
return array(
	//图片列表
	"CREATE TABLE IF NOT EXISTS `{prefix}tu` (
            ...
            `vip` mediumint(5) default '0' COMMENT '可播放组',
            `level` mediumint(5) default '0' COMMENT '可播放等级',
	...
	//图片分类
	"CREATE TABLE IF NOT EXISTS `{prefix}tu_list` (
	...
	//收费阅读记录
	"CREATE TABLE IF NOT EXISTS `{prefix}tu_look` (
            `id` int(10) unsigned NOT NULL auto_increment,
            `name` varchar(64) default '' COMMENT '图片名称',
            `cid` mediumint(5) unsigned default '0' COMMENT '图片分类ID',
            `did` varchar(128) default '' COMMENT '图片ID',
            `uid` int(10) unsigned default '0' COMMENT '会员ID',
            ...
            `addtime` int(10) unsigned default '0' COMMENT '时间',
             ...
             KEY `cid` (`cid`),
             KEY `did` (`did`)
          ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='图片收费阅读记录';",

	//图片专题
	"CREATE TABLE IF NOT EXISTS `{prefix}tu_topic` (
            `id` int(10) unsigned NOT NULL auto_increment,
            `name` varchar(64) default '' COMMENT '名称',
            ...
            `description` varchar(200) default '' COMMENT 'SEO介绍',
             ...
             KEY `zhits` (`zhits`),
             KEY `rhits` (`rhits`)
          ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='图片专题表';",

	//默认分类数据
	"INSERT INTO `{prefix}tu_list` (`id`, `name`, `bname`, `fid`, `xid`, `yid`, `skins`, `title`, `keywords`, `description`) VALUES
