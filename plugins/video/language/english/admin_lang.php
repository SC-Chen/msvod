...
$lang['tpl_238']  =  "The scanning stands inside the catalogue need not fill in, ( server hard drive path, audio-visual area the catalogue that bind to settle<font color=red>for example:F:\\look</font>), the path can't write into a database.";
