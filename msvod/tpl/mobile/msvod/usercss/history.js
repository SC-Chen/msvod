...
if(c>$MH.limit){break;}
if(a.video[i].link && a.video[i].pic && a.video[i].name){
img_li += "<li style=\"list-style:none;\"><a href=\"" + a.video[i].link + "\" target=\"_self\" style=\"line-height:23px;font-size:13px;text-decoration:none\">&nbsp;<small>"+c+"、</small>" + a.video[i].name + "</a></li>"
c++;
}
}
img_li = img_li != "" ? img_li : '<li style="text-align:center;line-height:35px;color:red;list-style:none">\u6CA1\u6709\u8BB0\u5F55</li>';
return "<div id=\"mh-box\" style=\"border:1px solid #828282;box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.2);border-top:10;height1:"+$MH.height+"px;overflow:hidden\"><div style=\"height:27px;line-height:27px;clear:both;\" id=\"mh-title\"><div style=\"float:right;display:inline\"><a href=\"javascript:void(0)\" onClick=\"$MH.showHistory(2);\" style=\"font-size:13px;color: #fff;text-decoration:none\">\u6E05\u7A7A</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onClick=\"$MH.showHistory(1);\" style=\"display:none;font-size:12px;color: #333;text-decoration:none\">\u9690\u85CF</a></div><strong style=\"padding-left:5px;font-size:15px;color:#999;font-weight:400;\">\u6211\u7684\u89C2\u770B\u5386\u53F2</strong></div><div id=\"mh-ul\"><ul style=\"margin:0px;border:0px;padding:0;\">" + img_li + "</ul><div style=\"clear:both\"></div></div></div>";
},
