...
class MsdjAlipay extends CI_Model {
...
$this->partner = MS_Alipay_ID; //合作身份者ID
$this->security_code = MS_Alipay_Key; //安全检验码
$this->seller_email = MS_Alipay_Name; //签约支付宝账号或卖家支付宝帐户
