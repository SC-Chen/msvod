<?php
//控制器
$lang['plub_01']	= '系统配置不合理，post_max_size值必须大于upload_max_filesize值，否则会出现“进度条100%卡住”，解决方案：<a style="color:red" target="_blank" href="http://www.jb51.net/article/38599.htm">这里</a>';
$lang['plub_02']	= '系统环境只允许上传%sMB文件，可以设置upload_max_filesize值提升上传大小，解决方案：<a style="color:red" target="_blank" href="http://www.jb51.net/article/38599.htm">这里</a>';
$lang['plub_03']	= '系统环境要求每次发布内容不能超过%sMB（含文件），可以设置post_max_size值提升发布大小，解决方案：<a style="color:red" target="_blank" href="http://www.jb51.net/article/38599.htm">这里</a>';
