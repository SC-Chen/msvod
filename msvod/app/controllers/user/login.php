...
class Login extends msvod_Controller {
...
$Mark_Text=str_replace("{msvod:title}",L('login_01')." - ".Web_Name,$template);
...
//可以用会员名、邮箱来进行登入
$sqlu="SELECT code,email,pass,sid,yid,uid,id,name,lognum,cion,vip,logtime,viptime,zid,zutime FROM ".MS_SqlPrefix."user where name='".$username."' or email='".$username."'";
