...
class Share extends msvod_Controller {
	...
	public function index()
	{
            ...
            $sql_string = "SELECT * FROM ".MS_SqlPrefix."share where 1=1";
			if(!empty($key)){
				 if($zd=='name'){
            ...
            $base_url = site_url('admin/share')."?zd=".$zd."&key=".$key;
	        $per_page = 15; 
	...
	public function del()
	{
			...
			$this->MsdjDB->get_del('blog',$id);
            admin_msg(L('plub_02'),site_url('admin/share'),'ok');  //操作成功
	}
}
